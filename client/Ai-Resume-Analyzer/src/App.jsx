    ...
    try {
      ...
      if (mode === "text") {
        response = await axios.post(
          ...
          { resumeText: resume },
          { timeout: 60000 } // ✅ FIX: wait 60 seconds for cold start
        )
      } else {
                  ...
                  {pdfFile ? (
                    <div className="flex flex-col items-center text-center space-y-4 z-10 animate-in zoom-in-95 duration-300">
                      ...
                      <div>
                        ...
                        <p className="text-slate-500 mt-1 font-medium">{(pdfFile.size / 1024 / 1024).toFixed(2)} MB</p>
                      </div>
                      <button
                        onClick={clearPdf}
                ...
                <span className="relative z-10 flex items-center space-x-2">
                  {loading ? (
                    <>
                      ...
                      {/* ✅ FIX: Inform user about possible wait */}
                      <span>Analyzing... (first load may take ~30s)</span>
                    </>
                  ) : (
                    <>
